...
// Initialize workers
import './services/jobs/PdfWorker';
...
app.get('/api/analytics/pdf', authenticate, authorize([Role.MANAGER, Role.FINANCIAL_ANALYST]), AnalyticsController.generatePdfReport);
app.get('/api/analytics/fuel_efficiency', authenticate, authorize([Role.MANAGER, Role.FINANCIAL_ANALYST]), AnalyticsController.getFuelEfficiencyTimeSeries);
